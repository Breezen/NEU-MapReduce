...
public class FineLock implements Runnable {
    ...
    private static ConcurrentHashMap<String, Integer> temp = new ConcurrentHashMap<>(), count = new ConcurrentHashMap<>();

    public FineLock(String threadName, List<String> rawData) {
